...
namespace Notebook.Global
{
    class KeyboardHooking
    {
        ...
        public delegate int keyboardHookProc(int code, int wParam, ref keyboardHookStruct IParam);  // callback에 대한 delegate
        ...
        {
            //keyboard 속성값이 들어오는 것을 찾아서 event
